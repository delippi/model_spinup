...
ROTDIR="/gpfs/hps2/ptmp/Donald.E.Lippi/fv3gfs_dl2rw/2018091100/$PSLOT"
...
CDUMP=@CDUMP@
MASTER=$CDUMP.t${CYC}z.$PDY.master.grb2
GB0p25=$CDUMP.t${CYC}z.$PDY.pgrb2.0p25
ATMDIR=$CDUMP.t${CYC}z.$PDY.atm.nemsio
SFCDIR=$CDUMP.t${CYC}z.$PDY.sfc.nemsio
...
while [[ $FH -ge $offset_low && $FH -lt $offset_high ]]; do
   ...
   if [[ $copy_files == "YES" ]]; then
      ...
      cp -p ${ROTDIR}/$CDUMP.$PDY0/$CYC/$CDUMP.t${CYC}z.master.grb2f${FH}  ./$MASTER
      cp -p ${ROTDIR}/$CDUMP.$PDY0/$CYC/$CDUMP.t${CYC}z.master.grb2if${FH} ./$MASTER
      cp -p ${ROTDIR}/$CDUMP.$PDY0/$CYC/$CDUMP.t${CYC}z.pgrb2b.0p25.f${FH} ./$GB0p25
      cp -p ${ROTDIR}/$CDUMP.$PDY0/$CYC/$CDUMP.t${CYC}z.atmf${FH}.nemsio ./$ATMDIR
      cp -p ${ROTDIR}/$CDUMP.$PDY0/$CYC/$CDUMP.t${CYC}z.sfcf${FH}.nemsio ./$SFCDIR
      echo $valtime
   fi
   (( FH=FH+24 ))
done
