...
while [[ $FH -le $FHEND ]]; do
   ...
   echo "cp -p ../templates/make_plots_anl_template.ksh make_plots_anl_${suffix}.ksh"
   cp -p ../templates/make_plots_anl_template.ksh make_plots_anl_${suffix}.ksh
   sed -i                     "s/@EXP@/${EXP}/g" make_plots_anl_${suffix}.ksh
   ...
   sed -i                    "s/@FHSTART@/$FH/g" make_plots_anl_${suffix}.ksh
   sed -i                      "s/@FHEND@/$FH/g" make_plots_anl_${suffix}.ksh
   sed -i     "s/@input_nemsio@/$input_nemsio/g" make_plots_anl_${suffix}.ksh
   sed -i       "s/@input_grib2@/$input_grib2/g" make_plots_anl_${suffix}.ksh

   #bsub < make_plots_anl_${suffix}.ksh
   ksh  make_plots_anl_${suffix}.ksh
