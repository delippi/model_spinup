...
gmemdir=/gpfs/hps2/ptmp/Donald.E.Lippi/fv3gfs_dl2rw/2018091100/FreeRunLow5-2018091100-2018091800/gdas.20180911/$cyc/
...
#.............................
  ...
  for file in $memdir/RESTART/${PDY}.${cyc}0000.*.nc; do
    ...
    if [ $fsufanl = "sfc_data" ]; then
      file2=$(echo $file2 | sed -e "s/sfc_data/sfc_data/g")
      $NLN $file $DATA/INPUT/$file2
    fi
  done
set +x
